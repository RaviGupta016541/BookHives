...
namespace booksHive.Controllers
{
    ...
    public class UsersService : ControllerBase
    {
        ...
        public UsersService(booksHiveContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Users>> PostUser(Users user)
        {
          if (_context.Users == null)
          {
              return Problem("Entity set 'booksHiveContext.User'  is null.");
          }
        ...
        [HttpPost("LoginUser")]
        public UserResponce Login(Login user)
        {
            ...
            {
                userResponce.Email = userAvailable.Email;
